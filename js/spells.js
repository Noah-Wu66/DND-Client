...
const spellsData = [
    ...
    },
    {
        ...
        duration: "24 小时",
        classes: ["吟游诗人", "德鲁伊", "游侠"],
        description: "该法术帮你让一只野兽相信你并无恶意。在施法距离内指定一只你能看见的野兽，而它也必须能看见你且能听到你的声音。该野兽必须进行一次感知豁免，豁免失败则将在法术持续时间内被你魅惑。如果它的智力为４或更高则法术直接失败。如果你或你的同伴对目标造成伤害，则法术终止。\n升环施法效应。使用２环或更高法术位施展该法术时，你使用的法术位每比１环高一环，就可以多选择一个野兽作为目标。"
    },
    {
        name: "动物信使",
        ...
        duration: "24 小时",
        classes: ["吟游诗人", "德鲁伊", "游侠"],
        description: "该法术令你可以利用动物传递信息。在施法距离内指定一只你能看见的微型野兽（比如松鼠 squirrel，蓝松鸦 blue jay，或是蝙蝠 bat）。再选择一个你曾造访过的地点，然后描述收信人的基本信息，如一个穿着城镇守卫制服的男人或女人或一个戴着尖顶帽子的红发矮人。最后再说出一段不超过二十五个单词的信息。目标野兽将会在法术持续时间内前往你选定的地点。会飞的信使 24 小时内可移动 50 里，不会飞的信使只能移动 25 里。\n信使抵达目的地后，会模仿你的声音把信息传递给你描述的人。信使只会把信息传递给符合你描述的人。如果法术持续时间内信使未能抵达目的地则信息将遗失，而曾作为信使的野兽将自行寻路返回你施法的地点。\n升环施法效应。使用 3 环或更高法术位施展该法术时，你使用的法术位每比 2 环高一环，其法术持续时间就增加 48 小时。"
    },
    {
        name: "动物形态",
    ...
    },
    {
        ...
        castingTime: "1 动作",
        range: "触及",
        components: "V、S、M（至少价值 25 gp 的金粉作为法术耗材）",
        duration: "直到被解除",
        classes: ["法师"],
        description: "你触碰关上的一扇门，一扇窗，一个箱子或其他出入口，并使目标在法术持续时间内保持锁闭状态。施法时，你还可以设定允许你和其他若干生物正常打开该物件。你还可以设置一条密语，在该锁闭物件 5 尺内念出密语时，秘法锁将被压制 1 分钟。该物件只有在法术被压制、被解除，或物件本身遭破坏时才能打开。\n对物件施放敲击术 将使其秘法锁 法术在 10 分钟内受压制。\n受该法术影响的物件更难被撬开或破坏。对其进行破坏或撬锁时，其相应 DC 增加 10。"
    },
    {
        name: "艾嘉西斯之铠",
    ...
    },
    {
        ...
        duration: "立即",
        classes: ["邪术师"],
        description: "你祈求乌黯之饥渴 Dark Hunger，哈达 Hadar 的力量。黑暗能量构成的触须从你身上蔓延而出并痛击 10 尺内的所有生物。范围内的所有生物都必须进行一次力量豁免，豁免失败者将受到 2d6 点黯蚀伤害，并其下一回合前都无法执行反应。豁免成功的生物伤害减半，且不受其他效应的影响。\n升环施法效应。使用２环或更高法术位施展该法术时，你使用的法术位每比１环高一环，法术的伤害就增加 1d6。"
    },
    {
        name: "星界投影",
        ...
        castingTime: "1 小时",
        range: "10 尺",
        components: "V、S、M（你必须为此法术影响的每个生物准备一枚至少价值 1,000 gp 的红锆石 jacinth，以及一根做工精细，至少价值 100 gp 的银棒，作为该法术的耗材。）",
        duration: "特殊",
        classes: ["牧师", "邪术师", "法师"],
    ...
    },
    {
        ...
        castingTime: "1 分钟",
        range: "自身",
        components: "V、S、M（一套绘有标记的短棒，骨头，或类似的象征物，价值至少 25 金币）",
        duration: "立即",
        classes: ["牧师"],
    ...
    },
    {
        ...
        castingTime: "8 小时",
        range: "触及",
        components: "V、S、M（一块价值至少 1,000gp 的玛瑙，作为该法术的耗材。）",
        duration: "立即",
        classes: ["吟游诗人", "德鲁伊"],
        description: "利用施法的 8 小时引导一块昂贵宝石中的魔法回路后，你触碰一个巨型或更小的野兽或植物作为法术目标。目标必须没有智力值或智力小于等于 3。受术后其智力变为 10，且学会说一门你所掌握的语言。如果目标是植物，则他获得使用枝、根、藤、蔓或类似部位移动的能力，并获得类似于人类的感官。DM 为启蒙植物决定属性数据，例子可参考怪物图鉴的启蒙灌木和启蒙树。\n被启蒙的植物或野兽在 30 日内处于被你魅惑的状态，或是直到你或你的盟友做出任何伤害它的举动。魅惑终止后，启蒙生物将根据你对待他的方式决定是否对你保持友善。"
    },
    {
        name: "灾祸术",
        englishName: "Bane",
    ...
    },
    {
        ...
        castingTime: "1 动作",
        range: "30 尺",
        components: "V、S、M（一钵圣水）",
        duration: "专注，至多 1 分钟",
        classes: ["牧师", "圣武士"],
        description: "你用言语祝福施法距离内至多三个生物。在法术持续时间内，每当受术目标进行攻击检定或豁免检定时，可以额外掷一次 d4 并加在其结果上。\n升环施法效应。使用 2 环或更高法术位施展该法术时，你使用的法术位每比 1 环高一环，就可以多指定一个目标。"
    },
    {
        name: "枯萎术",
        englishName: "Blight",
    ...
    },
    {
        ...
        description: "你尝试令敌人目盲或耳聋。在施法距离内指定一个你能看见的生物，而它也必须能看见你且能听到你的声音。该生物必须进行一次体质豁免，豁免失败则将在法术持续时间内陷入目盲或耳聋（由你选择）。目标可以在每次自己回合结束时再进行一次体质豁免，豁免成功则法术终止。\n升环施法效应。使用 3 环或更高法术位施展该法术时，你使用的法术位每比 2 环高一环，就可以多指定一个目标。"
    },
    {
        name: "闪现术",
        englishName: "Blink",
    ...
    },
    {
        ...
        duration: "专注，至多 1 分钟",
        classes: ["圣武士"],
        description: "你在法术终止前的下一次武器攻击命中某生物时武器闪烁如明星，并对目标额外造成 2d6 点光耀伤害。如果目标处于隐形状态，则该斩击将使其可见，且因其身上散发出５尺半径的微光而无法隐形，直至该法术终止。\n升环施法效应。使用３环或更高法术位施展该法术时，你使用的法术位每比２环高一环，法术的伤害就增加 1d6。"
    },
    {
        name: "燃烧之手",
    ...
    },
    {
        ...
        castingTime: "1 动作",
        range: "150 尺",
        components: "V、S、M（一些毛皮，一块琥珀，玻璃或一柄水晶权杖，以及三根银质别针。）",
        duration: "立即",
        classes: ["术士", "法师"],
    ...
    },
    {
        ...
        castingTime: "1 动作",
        range: "90 尺",
        components: "V、S、M（一枚至少价值 50 gp 的钻石）",
        duration: "立即",
        classes: ["术士", "法师"],
    ...
    },
    {
        ...
        castingTime: "1 动作",
        range: "150 尺",
        components: "V、S、M（研磨过的黑珍珠粉末，价值至少 500 gp）",
        duration: "立即",
        classes: ["术士", "邪术师", "法师"],
    ...
    },
    {
        ...
        castingTime: "10 分钟",
        range: "1 里",
        components: "V、S、M（价值至少 100 gp 的法器，选择聆听时用一个以珠宝装饰的号角，选择观察时用一颗玻璃眼珠）",
        duration: "专注，至多 10 分钟",
        classes: ["吟游诗人", "牧师", "术士", "法师"],
    ...
    },
    {
        ...
        castingTime: "1 小时",
        range: "触及",
        components: "V、S、M（一枚至少价值 1,000 gp 的钻石以及被克隆生物 1 立方寸的肉，作为该法术的耗材。外加一副至少价值 2,000 gp 的带密封功能的大容器，其尺寸必须足以存放一个中型生物，例如一个巨大的瓮或灵柩，或是立在地上充满浆状物质的卵囊，又或者充满盐水的水晶棺）",
        duration: "立即",
        classes: ["法师"],
        description: "此法术用以培养一个活体生物的无意识复制体作为其死亡时的保险措施。该克隆体在一个密封容器中成长，并在 120 日后成熟；你还可以为同一个生物制作较年轻版本的肉体。在未被使用前，该躯体会一直保持无意识的静止状态。\n克隆体成长成熟后，如果本体生物死亡，则其灵魂转移到克隆体中，前提是该灵魂必须保持自由且自愿复活。克隆体的肉体特质与本体相同，并具有相同的个性、记忆和能力，但并不拥有本体随身的装备。由于灵魂已经转移到别处，该生物原本的遗体（如果依然存在）失去活力，且不能被复活"
    },
    {
        name: "匕首之云",
        englishName: "Cloud of Daggers",
        level: 2,
        school: "咒法",
        castingTime: "1 动作",
        range: "60 尺",
        ...
        duration: "专注，至多 1 分钟",
        classes: ["吟游诗人", "术士", "邪术师", "法师"],
        description: "你在施法距离内指定一点，并以该点为中心，将一个边长 5 尺的立方区域充满魔法创造的旋转匕首。生物在区域内开始其回合，或者在一个回合内第一次进入该区域时将受到 4d4 的挥砍伤害。\n升环施法效应。使用 3 环或更高法术位施展该法术时，你使用的法术位每比 2 环高一环，法术的伤害就增加 2d4。"
    },
    {
        name: "死云术",
    ...
    },
    {
        ...
        castingTime: "1 分钟",
        range: "自身",
        components: "V、S、M（焚香和一小瓶圣水或邪水）",
        duration: "1 分钟",
        classes: ["牧师"],
        description: "你与所信奉神祇或其代理人进行联系，并询问至多三个能以是或否回答的问题。你必须在法术终止前完成提问，并在随后分别获得每个问题的答案。\n这些神能存在也并非全知全能，因此当问题涉及的信息超过神祇的认知范围时，你可能会得到一句不确定作为回答。另外当一个单词可能引致误导，或者与神祇的兴致相违背时，DM 可能会提供一句短语作为答案。\n若你在两次长休之间两次或更多次的施展该法术，则法术有一定的几率不给任何答复。此概率从第二次施展起每次累计 25％。其具体结果由 DM 暗骰决定。"
    },
    {
        name: "问道自然",
    ...
    },
    {
        ...
        duration: "专注，至多 1 分钟",
        classes: ["圣武士"],
        description: "你尝试强令一个生物与你决斗。指定施法距离内一个你能看见的生物作为法术的目标。该生物必须进行一次感知豁免，豁免失败则该生物将被你的神圣要求所吸引。在法术持续时间内，该生物对除你之外任何生物发动攻击检定时都具有劣势，并且每当其试图移动至与你相距超过 30 尺的距离时，都必须进行一次感知豁免。豁免成功则该目标的移动本回合内暂时不受该魔法限制。\n当你攻击另一个生物时，或者当你对另一个敌对生物施展法术时，又或者当一个你的友方生物对该目标造成伤害或者对其施展伤害性法术时，又或者你在距离该目标超过 30 尺的位置结束你的回合时，该法术终止。"
    },
    {
        name: "通晓语言",
    ...
    },
    {
        ...
        castingTime: "1 分钟",
        range: "90 尺",
        components: "V、S、M（气元素为点燃的焚香，土元素为陶土，火元素为硫和磷，水元素为水和沙子）",
        duration: "专注，至多 1 小时",
        classes: ["德鲁伊", "法师"],
    ...
    },
    {
        ...
        duration: "专注，至多 1 小时",
        classes: ["德鲁伊", "游侠"],
        description: "你召唤精类生物并使其显现在施法范围内一处你能看见但未被占据的空间。选择以下选项之一作为显现的生物：\n• 一个挑战等级 2 或更低的精类生物\n• 两个挑战等级 1 或更低的精类生物\n• 四个挑战等级 1/2 或更低的精类生物\n• 八个挑战等级 1/4 或更低的精类生物\n每个被该法术召唤的精类生物在生命值降为 0，或者法术终止时消失不见。\n被召唤的生物对你和你的伙伴保持友善关系。你将召唤出来的所有生物视为一个团体来骰出先攻，它们也依此获得其自己的行动回合。他们服从你发出的所有语言命令（不需要你作动作）。如果你不发出任何命令，这些生物会在敌对生物前保护自己，如果没有敌对生物则不执行任何动作。\n这些生物的具体数值由 DM 掌控。\n升环施法效应。使用更高法术位施展该法术时，选择上文所述召唤选项之一，并显现更多生物：6 环法术位显现两倍生物，8 环法术位显现三倍生物。"
    },
    {
        name: "异界探知",
        ...
        duration: "1 分钟",
        classes: ["术士", "邪术师", "法师"],
        description: "你与一名半神，或者一个古老的贤者亡魂，又或是其他异位面的神秘实体建立了精神的连接。与这些跨位面亚种生物进行的知性接触可能会增加你的精神负担，甚至导致精神崩溃。当你施展此法术时，进行一个 DC15 的智力豁免。豁免失败时，你受到 6d6 点心灵伤害并因此而变得错乱，直至完成一个长休以结束该状态。处于错乱状态时，你不能执行动作，不能理解其他生物说的话也无法阅读，你说出口的也都是一些含糊不清的语句。对你施放法术高等复原术 greater restora-tion 可以直接终止该效应。\n豁免成功时，你可以询问该实体五个问题。你必须在法术结束前提出你的问题。而你所提出的每条问题 DM 都可以用一个单词作回答，比如是、不是、可能、不可能、没关系或是不清楚（如果该实体不知道该问题答案时）。如果一个单词的答案可能导致误导，DM 可能会用一句短语来作为问题的答案。"
    },
    {
        name: "疫病术",
    ...
    },
    {
        ...
        castingTime: "10 分钟",
        range: "自身",
        components: "V、S、M（一尊你自己的塑像，其材质为象牙并以宝石作装饰，其价值至少为 1,500 gp）",
        duration: "10 日",
        classes: ["法师"],
        description: "选择一个你可以施展的 5 环或更低环阶法术，该法术的施法时间必须为 1 动作，且必须能够以你自身为目标。你以随因法术的形式施展该法术，即将其作为所施展触发术的一部分，并且同时消耗该法术与触发术的法术位。该随因法术并不立即生效，而是在特定状况发生时才触发其效应。你在施展这两个法术时，必须描述该触发状况的细节。例如，触发术与水下呼吸 water breathing 一起施放可以确保水下呼吸可以在你被水或其他液体淹没时自动触发其效应。\n随因法术的效应在相应状况第一次出现时立即生效，而无论你是否想要这么做，在这之后触发术终止。\n随因法术只能对你起作用，哪怕它通常可以指定其他目标现在也无法再作指定。你一次只能使用一个触发术，如果你在已施放该法术时再次施展该法术，则前一个触发术的效应立即终止。另外，当触发术的材料成分不在你的角色身上时，其法术效应也将立即终止。"
    },
    {
        name: "不灭明焰",
        ...
        castingTime: "1 动作",
        range: "触及",
        components: "V、S、M（价值 50 gp 的红宝石粉末，作为该法术的耗材）",
        duration: "直至被解除",
        classes: ["牧师", "法师"],
    ...
    },
    {
        ...
        duration: "8 小时",
        classes: ["游侠"],
        description: "你将四发非魔法的弹药（箭或者弩矢）插在施法距离内的地面并在其上附加魔法让其防御这片区域。直至法术终止前，箭矢将警戒其周围 30 尺的区域，任何生物在一回合内第一次进入该区域或者在该区域结束其回合时，其中一发箭矢将飞起并射向该生物。该生物必须进行一次敏捷豁免，豁免失败者将受到 1d6点穿刺伤害，而射向目标的一发箭矢也将随之被摧毁。当所有箭矢都以该方式摧毁后，法术将随之终止。\n施展该法术时，你可以指定任意的生物使法术的警戒效应将其排除在外。\n升环施法效应。使用 3 环或更高法术位施展该法术时，你的法术位每比 2 环高一环，可生效的弹药数量就增加两发。"
    },
    {
        name: "法术反制",
        ...
        duration: "立即",
        classes: ["术士", "邪术师", "法师"],
        description: "你试图打断一个生物正在施展的一个法术。如果该生物正在施展 3 环或更低环阶法术，则其法术失败且不产生任何效应。如果该生物正在施展 4 环或更高环阶法术，则你以施法关键属性进行一次属性检定，其检定 DC 等于 10＋目标法术的环阶。检定成功则目标法术失败且不产生任何效应。\n升环施法效应。使用 4 环或更高法术位施展该法术时，如果被打断法术的环阶不高于你所用的法术位环阶，则该目标法术直接被打断。"
    },
    {
        name: "造粮术",
    ...
    },
    {
        ...
        castingTime: "1 分钟",
        range: "30 尺",
        components: "V、S、M（所创造物品的一小部分）",
        duration: "特殊",
        classes: ["术士", "法师"],
        description: "你从堕影冥界取来一些暗影物质，并在施法距离内创造一个非活体的物件。你可以创造一个植物质（类似纺织品、绳索、木质等）的物件。也可以创造一个矿物质（类似石质、水晶、金属等）的物件。创造出来的物件大小必需在 5 尺立方内，且其形态与材质你必需曾经见过。\n法术的持续时间由所创造物件的材质决定。如果所创造物件由多种材质组合而成，则其存在时间取其中最短者。\n材质 持续时间 \n植物质 vegetable matter 1 日\n石质 stone 或水晶 crystal 12 小时\n贵金属 precious metals 1 小时\n宝石 gems 10 分钟\n精金 adamantine 或秘银 mithral 1 分钟\n施展其他法术时，如果以这些创造物作为其材料成分将会使该法术施法失败。\n升环施法效应。使用 6 环或更高法术位施展该法术时，你使用的法术位每比 5 环高一环，创造物尺寸的立方边长就加大 5 尺。"
    },
    {
        name: "疯狂冠冕",
        englishName: "Crown of Madness",
        level: 2,
        school: "附魔",
        castingTime: "1 动作",
        range: "120 尺",
    ...
    },
    {
        ...
        description: "一个你触碰的生物恢复特定数值的生命值，其恢复量等于 1d8＋你的施法关键属性调整值。该法术对不死生物和构装生物无效。\n升环施法效应。使用 2 环或更高法术位施展该法术时，你使用的法术位每比 1 环高一环，恢复量就增加 1d8。"
    },
    {
        name: "舞光术",
    ...
    },
    {
        ...
        components: "V、S",
        duration: "专注，至多 10 分钟",
        classes: ["吟游诗人", "牧师", "德鲁伊", "圣武士", "游侠", "术士", "法师"],
        description: "你在法术持续时间内能感测到 30 尺内存在的魔法。感测到魔法的存在后，你可以使用动作，并实现观察任何你能看见的生物或物件周围微弱的灵光，并分辨出其所属的魔法学派。\n该法术可以穿透大部分障碍，但仍会被 1 尺厚石质，或 1 寸厚金属质，或一层薄铅质，或 3 尺厚木质或泥质材料阻隔。"
    },
    {
        name: "侦测毒性和疾病",
    ...
    },
    {
        ...
        description: "在施法距离内指定一个生物、一个物件或一处魔法效应，并终止所有影响该目标的 3 环或更低环阶法术。每个影响目标的 4 环或更高环阶法术都需要以你的施法关键属性进行一次属性检定，其 DC 等于 10＋目标法术的环阶，检定成功时目标法术终止。\n升环施法效应。使用 4 环或更高法术位施展该法术时，你直接终止目标身上小于等于该施法环阶的法术效应。"
    },
    {
        name: "不谐低语",
    ...
    },
    {
        ...
        castingTime: "1 动作",
        range: "自身",
        components: "V、S、M（适合你宗教信仰的熏香和祭品，总共价值至少 25 金币，作为该法术的耗材）",
        duration: "立即",
        classes: ["牧师"],
        description: "你的魔法和贡品让你得以与一名神祇或神仆取得联络。你可以就某个特定的目标、事件或活动提问一个与其 7 日内状况相关的问题。DM 将给予你真实的答复，这个答复可能是一段短语、一节神秘的短诗或是一个预兆。\n此法术的回答并不会顾及所有可能影响结果的情况。比如其他法术的影响，或者同伴的加入和离开等状况。\n若你在两次长休之间两次或更多次的施展该法术，则法术有概率会给出随机的结果。此概率从第二次施展起每次累计 25％。其具体结果由 DM 暗骰决定。"
    },
    {
        name: "神恩",
    ...
    },
    {
        ...
        duration: "专注，至多 1 小时",
        classes: ["吟游诗人", "术士", "邪术师", "法师"],
        description: "你试图安抚一个施法距离内你能看见的生物，必须成功通过一次感知豁免，否则将在法术持续时间内被你魅惑。若它正与你或你的友方生物战斗，则其进行该豁免时具有优势。\n该生物被魅惑时，只要你与其处于同一位面就可以与之保持心灵感应。你在有意识时，可以通过心灵感应命令该生物（不需要作动作），而它则会尽量服从。你可以描述一个简单具体的行为指令，比如攻击那个生物、跑到那个位置或是去拿那个物品。生物完成一项指令却未收到你的进一步指示时，将会使用其本身的能力尽可能的保护自己。\n你可以使用动作以彻底而精确的控制目标。而该生物则只能作你选择的动作，且不能作任何你没有允许的动作，并持续至你下回合结束。在此期间，你还可以要求该生物作一个反应，但这需要你使用自己的反应来实现。\n每次目标受到伤害时，都可以尝试进行一次感知豁免，豁免成功则法术终止。\n升环施法效应。使用 9 环法术位施展该法术时，持续时间变为：专注，至多 8 小时。"
    },
    {
        name: "支配人类",
    ...
    },
    {
        ...
        castingTime: "1 分钟",
        range: "触及",
        components: "V、S、M（一枚价值 1000gp 的蓝宝石）",
        duration: "直至被解除",
        classes: ["法师"],
    ...
    },
    {
        ...
        castingTime: "1 分钟",
        range: "特殊",
        components: "V、S、M（一把沙子，一点墨水，和一支从沉睡的鸟儿身上拔下的可书写羽毛）",
        duration: "8 小时",
        classes: ["吟游诗人", "邪术师", "法师"],
    ...
    },
    {
        ...
        duration: "专注，至多 1 小时",
        classes: ["圣武士"],
        description: "你触碰的一把非魔法武器并使其变成魔法武器。选择以下伤害类型其中之一：强酸、冷冻、火焰、闪电、雷鸣。在法术持续时间内，该武器进行攻击检定时将获得+1 加值，且在命中时额外造成 1d4 点所选类型的伤害。\n升环施法效应。使用 5 环或 6 环法术位施展该法术时，攻击检定的加值变为+2，额外伤害变为 2d4。使用 7 环或更高法术位施展该法术时，攻击检定的加值变为+3，额外伤害变为 3d4。"
    },
    {
        name: "强化属性",
    ...
    },
    {
        ...
        duration: "专注，至多 1 分钟",
        classes: ["术士", "法师"],
        description: "你使施法距离内一个你能看见的生物或物件的大小发生改变，并在法术持续时间内维持其效应。指定一个生物或一件没有被着装携带的物品，如果目标并非自愿，则其可以进行一次体质豁免，豁免成功则法术无效。\n如果目标是生物，则其着装物和携带物的尺寸也随之变化。随后任何从该生物身上脱离的物品都会恢复其正常大小。\n变巨 Enlarge。目标身形尺寸变为两倍，重量变为八倍。其体型也因此提高一级，比如中型变为大型。如果目标所处空间不够容纳其变巨后的身形，则该生物或物品在有限空间下会尽可能地达到最大尺寸。在法术终止前，目标进行力量检定和力量豁免时具有优势。目标的武器也会随之变大，而使用这变大的武器发动攻击时，将造成额外 1d4 的伤害。\n缩小 Reduce。目标身形尺寸变为一半，重量变为八分之一。其体型也因此降低一级，比如中型变为小型。在法术终止前，目标进行力量检定和力量豁免时具有劣势。目标的武器也会随之变小，而使用这变小的武器攻击时，将减少 1d4 的伤害（不会使伤害值低于 1）。"
    },
    {
        "name": "诱捕打击",
    ...
    },
    {
        ...
        "duration": "1 分钟",
        "classes": ["吟游诗人", "邪术师"],
        "description": "你编排了一段使人分心的话语，并指定施法距离内一个你能看见且可以听到你声音的生物作为法术目标。目标生物必须进行一次感知豁免并成功通过。任何不能被魅惑的生物进行该豁免时直接判定为豁免成功。如果你或你的同伴正在和该生物战斗，则其进行该豁免时具有优势。豁免失败时，目标对除你以外其他生物进行的感知（察觉）检定具有劣势，直到法术终止或目标听不到你为止。如果你陷入失能状态或不能再说话，则该法术终止。"
    },
    {
        "name": "以太化",
    ...
    },
    {
        ...
        "duration": "专注，至多 10 分钟",
        "classes": ["术士", "邪术师", "法师"],
        "description": "此法术让你以惊人的步速移动。你在施展该法术时可以执行一次疾走动作。其后直至法术终止前的每个自己回合，你能以一个附赠动作执行疾走动作。"
    },
    {
        "name": "摄心目光",
        "englishName": "Eyebite",
    ...
    },
    {
        ...
        "duration": "1 小时",
        "classes": ["术士", "法师"],
        "description": "你从死灵法术中获得了额外的生命力。在法术持续时间内，你获得 1d4+4 的临时生命值。\n升环施法效应。使用 2 环或更高法术位施展该法术时，你使用的法术位每比1环高一环，其给予的临时生命值就增加5。"
    },
    {
        "name": "恐惧术",
        "englishName": "Fear",
        ...
        "duration": "专注，至多 1 分钟",
        "classes": ["吟游诗人", "术士", "邪术师", "法师"],
        "description": "你制造一个目标最惧怕的幻象，并迫使 30 尺锥状区域内的所有生物进行一次感知豁免，豁免失败者将丢弃其所有持握物，并在法术持续时间内陷入恐慌。\n被法术恐慌的生物必须在其回合内执行疾走 Dash 动作，并以此寻找最安全的路线远离施法者，直至其无路可走为止。如果该生物在施法者视线范围外结束其回合，则其可以再进行一次感知豁免，豁免成功则法术对该生物的效应终止。"
    },
    {
        "name": "羽落术",
    ...
    },
    {
        ...
        "castingTime": "1 分钟",
        "range": "自身",
        "components": "V、S、M（一套占卜用具，比如骨头、象牙、卡片、牙齿、雕刻符文等，其价值至少为 100 gp，此外还需要一个来自你所寻找地点的物件）",
        "duration": "专注，至多 1 日",
        "classes": ["吟游诗人", "牧师", "德鲁伊"],
        "description": "该法术可以搜寻同一位面的另一处你熟悉的特定地点，法术会找出通往该处最短、最直接的道路。如果你寻找的目的地在另一位面，或者其会不断移动（例如一座移动堡垒），或者描述不够具体（例如一个绿龙的巢穿），该法术失效。\n你在法术持续时间内只要和目的地在同一位面，就知晓目的地的远近和所在方向。向目的地移动并遇到岔路时，你会本能的选择通往目的地最近、最直接的路（但不一定最安全）。"
    },
    {
        "name": "寻找陷阱",
        ...
        "duration": "立即",
        "classes": ["牧师", "德鲁伊", "游侠"],
        "description": "你感测到施法距离范围内，且在你视线范围内的任何陷阱。该法术的目标陷阱包括任何可能引发的，对你有害或对你构成妨碍的突发性意外效应，而其性质也正是其创作者的意图。因此该法术可以感测警报术 alarm 和守卫刻文 glyph of warding 的效应区域，也可以发现某个陷坑型机械陷阱。不过它不能揭示地板的某处脆弱点，或天花板的某处不稳定位置，又或是某个隐藏的阴沟。\n该法术只单纯揭示陷阱的存在。你并不能以此一一定位每个存在的陷阱，不过你可以知晓所感测到陷阱其能够构成危害的大致形式。"
    },
    {
        "name": "死亡一指",
    ...
    },
    {
        ...
        "duration": "专注，至多 1 小时",
        "classes": ["德鲁伊", "游侠", "术士", "法师"],
        "description": "你以施法距离内一点为中心创造一片半径 20 尺的球状浓雾。浓雾再球形内充斥所有角落，并造成重度遮蔽。浓雾持续至法术持续时间结束，但仍可被和风或更强风势（至少每小时10 里）所吹散。\n升环施法效应。使用 2 环或更高法术位施展该法术时，你使用的法术位每比 1 环高一环，浓雾的半径就增加 20 尺。"
    },
    {
        "name": "禁制术",
    ...
    },
    {
        ...
        "castingTime": "１动作",
        "range": "60 尺",
        "components": "V、S、M（一枚价值至少 5,000 gp 的钻石）",
        "duration": "专注，至多１分钟",
        "classes": ["牧师", "术士", "法师"],
    ...
    },
    {
        ...
        "description": "你对施法距离内你能看见的一个生物置入一条魔法命令，并强迫其执行相应的某种服务或克制某种行为，甚至遵照你的要求行动。如果该生物可以理解你的意思，则它必须成功通过一次感知豁免，否则将在法术持续时间内被你魅惑；对于成功通过豁免的生物，若你再次对其施展该法术，则它对该法术免疫。被魅惑生物每次作出与你的命令相悖的行为时，即受到 5d10 点心灵伤害。该伤害一日至多生效一次。且不能理解你意思的生物不受该法术影响。\n除了涉及导致必死结果的行为外，你向目标下达的任何命令都会生效。如果你发布自杀指令则法术即时终止。\n你可以用一个动作解除命令并终止法术。法术如移除诅咒 remove curse，高等复原术 greater restoration 或祈愿术 wish 同样可以终止该法术。\n升环施法效应。使用 7 环或 8 环法术位施展该法术时，持续时间变为 1 年。使用 9 环法术位施展该法术时，法术将一直持续至被上文提及的法术所终止。"
    },
    {
        "name": "遗体防腐",
    ...
    },
    {
        ...
        "castingTime": "1 动作",
        "range": "自身（10 尺半径）",
        "components": "V、S、M（一个玻璃质或水晶质的珠子，其将在法术终止时破碎）",
        "duration": "专注，至多 1 小时",
        "classes": ["术士", "法师"],
    ...
    },
    {
        ...
        "castingTime": "1 动作",
        "range": "触及",
        "components": "V、S、M（价值至少 100 gp 的钻石粉，作为该法术的耗材）",
        "duration": "立即",
        "classes": ["吟游诗人", "牧师", "德鲁伊"],
    ...
    },
    {
        ...
        "castingTime": "24 小时",
        "range": "触及",
        "components": "V、S、M（价值至少 1,000 gp 的草药、油与熏香，作为该法术的耗材）",
        "duration": "直至解除",
        "classes": ["牧师"],
    ...
    },
    {
        ...
        "duration": "专注，至多 1 分钟",
        "classes": ["术士", "法师"],
        "description": "指定施法距离内一个你能看见的自愿生物。直至法术终止前，你使目标速度翻倍；其 AC 获得 +2 加值；其进行敏捷豁免时具有优势；其每个回合都可作出一个额外的动作，但该动作只能发动攻击（只限一次武器攻击），或者疾行、撤离、躲藏和使用物件。\n法术终止时，目标将泛起一阵倦意使其不能移动也无法执行动作，并持续至其下一回合结束。"
    },
    {
        "name": "医疗术",
        "englishName": "Heal",
    ...
    },
    {
        ...
        "duration": "立即",
        "classes": ["吟游诗人", "牧师", "德鲁伊"],
        "description": "你指定施法距离内一个你能看见的生物并恢复期生命值，恢复量等于 1d4＋你的施法关键属性调整值。该法术对构装体和不死生物无效。\n升环施法效应。使用 2 环或更高法术位施展该法术时，你使用的法术位每比 1 环高一环，治疗量就增加 1d4 点。"
    },
    {
        "name": "灼热金属",
    ...
    {
        "name": "英雄宴",
        "englishName": "Hero's Feast",
        "level": 6,
        "school": "咒法",
        "castingTime": "10 分钟",
        "range": "30 尺",
        "components": "V、S、M（一个价值至少 1,000 gp 的镶饰宝石的碗，作为法术的耗材）",
        "duration": "立即",
        "classes": ["牧师", "德鲁伊"],
    ...
    },
    {
        ...
        "castingTime": "1 附赠动作",
        "range": "90 英尺",
        "components": "V、S、M（一只被石化的蝾螈 newt 眼睛）",
        "duration": "专注，至多 1 小时",
        "classes": ["邪术师"],
    ...
    },
    {
        ...
        "castingTime": "1 动作",
        "range": "自身",
        "components": "V、S、M（一个价值至少 1,000 gp 的小圣物箱，内含一件圣遗物，例如某位圣者长袍上的一片碎布，或者某本宗教典籍中的一张羊皮纸）",
        "duration": "专注，至多 1 分钟",
        "classes": ["牧师"],
    ...
    },
    {
        ...
        "castingTime": "1 分钟",
        "range": "触及",
        "components": "V、S、M（一颗价值至少 100 gp 的珍珠和一根猫头鹰羽毛）",
        "duration": "立即",
        "isRitual": true,
        "classes": ["吟游诗人", "法师"],
    ...
    {
        "name": "迷幻手稿",
        "englishName": "Illusory Script",
        "level": 1,
        "school": "幻术",
        "castingTime": "1 分钟",
        "range": "触及",
        "components": "S、M（价值至少 10 gp 的铅料墨水，作为法术的耗材）",
        "duration": "10 日",
        "isRitual": true,
        "classes": ["吟游诗人", "邪术师", "法师"],
    ...
    },
    {
        ...
        "duration": "专注，至多 1 分钟",
        "classes": ["术士", "法师"],
        "description": "一片充满了炽热灰烬的旋转烟云显现，并以施法距离内一点为中心的蔓延至半径 20 尺的球状区域。烟云会绕过拐角扩散并使整个区域处于重度遮蔽，并在法术终止前持续存在。此外烟云还可以被和风或强度等级更高的风势（风速至少每小时10 里）所吹散。\n烟云出现时，每个处在其内的生物都必须进行一次敏捷豁免，豁免失败者将受到 10d8 的火焰伤害，豁免成功则伤害减半。生物在一个回合内第一次进入烟云内，或者在烟云内结束其回合时，也必须进行该豁免。\n在你的每回合开始时，烟云会向你指定的方向直线移动 10 尺。"
    },
    {
        "name": "致伤术",
    ...
    },
    {
        ...
        "castingTime": "10 分钟",
        "range": "自身",
        "components": "V、S、M（价值至少 250 gp 的熏香，作为法术的耗材。以及每块价值至少 50 gp 的四块象牙板）",
        "duration": "立即",
        "classes": ["吟游诗人", "牧师", "法师"],
    ...
    },
    {
        ...
        "duration": "立即",
        "classes": ["术士", "法师"],
        "description": "一束 100 尺长，5 尺宽的的线状闪电从你的位置向你指定的任意方向爆发迸出。在线状区域内的每个生物必须进行一次敏捷豁免，豁免失败者将受到 8d6 的闪电伤害，豁免成功则伤害减半。\n闪电会将区域内未被着装或携带的可燃物件点燃。\n升环施法效应。使用 4 环或更高法术位施展该法术时，你使用的法术位每比 3 环高一环，伤害就增加 1d6。"
    },
    {
        "name": "动植物定位术",
        ...
        "isRitual": true,
        "classes": ["吟游诗人", "德鲁伊", "游侠"],
        "description": "你点名或描述一种兽类或植物，并专注于附近的自然之音。如果 5 里内存在该类生物，你将知晓其中最接近个体与你的相对方位和距离。"
    },
    {
        "name": "生物定位术",
    ...
    },
    {
        ...
        "castingTime": "1 分钟",
        "range": "10 尺",
        "components": "V、S、M（总价值至少 100 gp 的圣水或银、铁粉，作为该法术的耗材）",
        "duration": "1 小时",
    ...
    },
    {
        ...
        "castingTime": "1 分钟",
        "range": "自身",
        "components": "V、S、M（一块宝石或水晶，或者一个圣物匣，又或者他带装饰的容器，其价值不能低于 500 gp）",
        "duration": "直至被解除",
        "classes": ["法师"],
    ...
    },
    {
        ...
        "duration": "立即",
        "classes": ["术士", "法师"],
        "description": "你创造三枚由魔法力场形成的闪光飞镖，并让每发飞镖命中施法距离内你能看见的指定生物。每发飞镖对目标造成 1d4+1 的力场伤害。所有飞镖同将时命中目标，而你还可以指定它们击中同一个目标或是分别击中几个目标。\n升环施法效应。使用 2 环或更高法术位施展该法术时，你使用的法术位每比 1 环高一环，该法术就会多制造出一支飞镖。"
    },
    {
        "name": "魔嘴术",
        ...
        "castingTime": "1 分钟",
        "range": "30 尺",
        "components": "V、S、M（一小块蜂窝和至少价值 10 gp 的翡翠粉作为法术的耗材）",
        "duration": "直至解除",
        "isRitual": true,
        "classes": ["吟游诗人", "法师"],
    ...
    },
    {
        ...
        "duration": "立即",
        "classes": ["吟游诗人", "牧师", "德鲁伊"],
        "description": "一波治愈的能量从施法距离内你指定的一点奔涌而出。你在该点周边 30 尺半径的球状区域内指定至多六个生物，并使每个目标生物恢复一定的生命值，其数值等于 3d8＋你的施法关键属性调整值。该法术对不死生物和构装生物无效。\n升环施法效应。使用 6 环或更高法术位施展该法术时，你使用的法术位每比 5 环高一环，其治疗量就增加 1d8。"
    },
    {
        "name": "群体医疗术",
    ...
    },
    {
        ...
        "duration": "立即",
        "classes": ["牧师"],
        "description": "你高声诵出复原的真言，并指定施法距离内至多六个你能看见的生物，使其各自恢复一定的生命值，其数值等于 1d4＋你的施法关键属性调整值。该法术对不死生物和构装生物无效。\n升环施法效应。使用 4 环或更高法术位施展该法术时，你使用的法术位每比 3 环高一环，其治疗量就增加 1d4。"
    },
    {
        "name": "群体暗示术",
    ...
    },
    {
        ...
        "duration": "立即",
        "classes": ["法师"],
        "description": "一支闪烁的绿色箭矢疾速的飞向一个施法距离内的目标，并爆散成强酸水雾。法术对目标发动一次远程法术攻击。若命中，则目标立即受到 4d4 点强酸伤害，并在其下一回合结束时再受到 2d4点强酸伤害。若未命中，则酸液箭矢溅射到了目标，造成初始伤害一半的伤害，并且不会在下一回合结束时造成伤害。\n升环施法效应。使用 3 环或更高法术位施展该法术时，你使用的法术位每比 2 环高一环，其初始伤害和后续伤害就各增加 1d4。"
    },
    {
        "name": "修复术",
        "englishName": "Mending",
    ...
    },
    {
        ...
        "duration": "24 小时",
        "classes": ["吟游诗人", "法师"],
        "description": "直至法术终止前，你所触碰的一个自愿生物对下列项目具有免疫：心灵伤害；任何可以感知到其情绪或阅读其思想的效应；预言法术；魅惑状态。当目标受祈愿术 wish 或者其他威力相当的法术或效应影响心智或窃获信息时，其也能以该法术进行阻挡。"
    },
    {
        "name": "次级幻影",
    ...
    },
    {
        ...
        "castingTime": "1 分钟",
        "range": "300 尺",
        "components": "V、S、M（一个象牙雕琢的拱门小模型、一块打磨过的大理石和一把微型银汤匙，每件物品至少价值 5 gp）",
        "duration": "24 小时",
        "classes": ["吟游诗人", "法师"],
    ...
    {
        "name": "摩登肯私人密室",
        "englishName": "Mordenkainen's Private Sanctum",
        "level": 4,
        "school": "防护",
        "castingTime": "10 分钟",
        "range": "120 尺",
    ...
    },
    {
        ...
        "castingTime": "1 动作",
        "range": "60 尺",
        "components": "V、S、M（一把剑柄和柄端由铜与锌打造的微缩铂金剑，价值 250gp）",
        "duration": "专注，至多 1 分钟",
        "classes": ["吟游诗人", "法师"],
    ...
    },
    {
        ...
        "castingTime": "1 动作",
        "range": "120 尺",
        "components": "V、S、M（一把铁刃以及一个小袋子，袋内装着黏土、壤土、砂土等混成的泥土）",
        "duration": "专注，至多 2 小时",
        "classes": ["德鲁伊", "术士", "法师"],
        "description": "指定施法距离内边长不大于 40 尺的方状地形区域，并以任意的方式重塑区域内的泥土，沙土或黏土。你可以升高或降低区域内的地面高度，制造或填平一道沟渠，升起或夷平一座山丘，或者塑造一根立柱。被改变的地形范围在最长不得超过整个区域最长边长的一半。因此，如果你影响了 40 尺方状区域，则你可以创造一根至多 20 尺高的立柱，将地面升高或降低至多 20 尺，挖一条至多 20 尺深的壕沟，等等。这些改变需要花 10 分钟的时间来完成。\n每为法术维持 10 分钟专注，你都可以选择一片新的地形区域再施以影响。\n由于地形的变化发生得很缓慢，区域内的生物通常不会被地面的移动困住或者受伤。\n该法术无法改变天然的岩石或石制建筑。但石头和建筑仍会因适应地形的变化而被改变。如果你改变地形的方式会使得建筑不稳定，则它有可能倒塌。\n此外，该法术也无法直接影响植物生长。而被移走的土壤会带走任何生长在其上的植物。"
    },
    {
        "name": "回避侦测",
        ...
        "castingTime": "1 动作",
        "range": "触及",
        "components": "V、S、M（一撮价值至少 25gp 的钻石粉末，撒在目标身上作为该法术的耗材）",
        "duration": "8 小时",
        "classes": ["吟游诗人", "游侠", "法师"],
        "description": "在法术持续时间内，你触碰一个目标并使其躲开来自预言魔法的侦测。目标可以是一个自愿生物，一处地点或一个在各个方向上不超过 10 尺的物件。目标在持续时间内不能成为预言魔法的目标，也不能通过魔法探知传感器被感测到。"
    },
    {
        "name": "涅斯图魔法灵光",
    ...
    },
    {
        ...
        "duration": "1 小时",
        "classes": ["法师"],
        "description": "你指定施法距离内一处未被占据空间，并从中显现一只似幻似真的马形生物。该生物的外形由你决定，但它必须装备着鞍座和辔具。而这些随法术创造的装备一旦离开战驹 10 尺即化作一阵烟消失不见。\n在法术持续时间内，你或者一个你指定的生物可以骑乘此战驹。战驹使用骑乘用马的属性数据，不过其具有速度 100尺，其每小时路程普通时可达 10 里，以快速步调行进时可达 13 里。法术终止时，战驹会慢慢消失，让骑手有 1 分钟的时间下马结束骑乘。你用一个动作解散战驹，或是当战驹受到伤害时，法术也将随即终止。"
    },
    {
        "name": "异界誓盟",
        ...
        "duration": "立即",
        "classes": ["牧师"],
        "description": "你祈求一个异界个体的援助。你必须对该存在个体有所了解，它可以是一个神祗，一位原祖，一名恶魔主君，或是其他界域级力量的存在。该存在将派遣一个效忠它的天界生物，元素生物或邪魔来援助你，并使该个生物显现在施法距离内一个未占据空间。如果你知道他们中某个特定生物的名字，则你可以在施展该法术时说出其名字来请求指派该生物来援，但是你仍然有可能得到一个不同的生物（由 DM 选择）。\n该生物出现时，你无法强迫它作任何事。你可以以报酬为交换请求其提供服务，只是它并没任何义务为你实现。请求的任务可以简单（帮我们飞越峡谷，或在一场战斗中提供协助），也可以复杂（暗中监视我们的敌人，或在我们扫荡地城时保护我们）。你必须能与该生物交流以为他服务的报酬讨价还价。\n报酬的形式也可以各式各样。一个天界生物可能会要求为一座同盟的神殿捐献一份相当可观的金币或魔法物品，而一只邪魔可能会索要一次活祭或一份财宝作为礼物。一些生物可能会要求你进行一个任务来换取它们的服务。\n粗略计算，一个可以按分钟计算的任务需要每分钟 100 gp的报酬。一个可以按小时计算的任务需要每小时 1,000 gp 的报酬。一个可以按日计算的任务（至多 10 日）需要每日 10,000 gp 的报酬。DM 可以按你施放该法术的环境调整具体的报酬。如果任务与生物的行为准则一致，则报酬可能会被减半甚至放弃。没有风险的任务一般只需要建议报酬的一半，而特别危险的任务可能会需要更大的赠礼。生物极少接受看上去像自杀的任务。\n生物完成任务后，或当协议服务时间结束后，如果任务合适并在可能的情况下，生物会在回来向你报告后再返回自己的家乡位面。如果你不能同意生物的服务价格，则其将立即返回其家乡位面。\n应召加入你队伍的生物算作队伍成员，并正常分享获得的经验值。"
    },
    {
        "name": "异界誓缚",
        ...
        "castingTime": "1 小时",
        "range": "60 尺",
        "components": "V、S、M（一枚价值至少 1000gp 的宝石，作为该法术的耗材）",
        "duration": "24 小时",
        "classes": ["吟游诗人", "牧师", "德鲁伊", "法师"],
        "description": "你尝试以该法术与一个生物建立誓约使其为你服务，该生物可以是天界生物、元素生物、精类生物、邪魔等生物种类之一。该生物在整个施法过程中必须在法术的施法距离内。典型的情况下，在施展该法术前，生物会先被召唤到一个反向作用的防护法阵 magic circle 中困住。施法完成后，目标必须进行一次魅力豁免。豁免失败则目标在法术持续时间内与你建立誓约并服务于你。如果该生物由其他法术所召唤或创造，则维持其存在的法术持续时间被延长至符合本法术的持续时间。\n一个已建立誓约的生物必须尽其最大的能力遵从你的指示。你可以命令该生物在你冒险时陪伴你，或守卫一个地点，又或者传递一个信息。该生物将遵从你所下达指示的字面意义，但是如果此生物与你敌对，则它会努力曲解你的字面意思来达到它自己的目标。如果生物在法术终止前全部完成了你的指示而你们仍处于同一位面时，则它会到你面前向你汇报。如果你们处与不同位面，则它会回到其建立誓约之地，并呆停留该处直至法术终止。\n升环施法效应。使用 6 环法术位施展该法术时，法术持续时间增为 10 日，7 环则增为 30 日，8 环为 180 日，9 环为一年零一日。"
    },
    {
        "name": "异界传送",
        ...
        "castingTime": "1 动作",
        "range": "触及",
        "components": "V、S、M（一根与某个位面完成同调，价值至少 250gp 的分叉金属短棒）",
        "duration": "立即",
    ...
    },
    {
        ...
        "duration": "立即",
        "classes": ["吟游诗人", "术士", "邪术师", "法师"],
        "description": "你读出一威力满溢的单词，其足以使施法距离内一个你能看见的生物立即死亡。如果你所指定的生物现有生命值为 100或更少，则其立即死亡。否则该法术不产生任何效应。"
    },
    {
        "name": "律令震慑",
    ...
    },
    {
        ...
        "duration": "立即",
        "classes": ["牧师"],
        "description": "你指定施法距离内至多六个你能看见的生物，并使其每人恢复 2d8＋你施法关键属性调整值的生命值。该法术对不死生物和构装体不产生任何效应。\n升环施法效应。当你使用 3 环或更高法术位施展该法术时，你使用的法术位每比 2 环高一环，治疗量就增加 1d8。"
    },
    {
        "name": "魔法伎俩",
    ...
    },
    {
        ...
        "castingTime": "1 动作",
        "range": "120 尺",
        "components": "V、S，M（一点羊毛和价值至少 25gp 的翡翠粉末）",
        "duration": "直至被驱散",
        "classes": ["吟游诗人", "法师"],
    ...
    },
    {
        ...
        "castingTime": "1 动作",
        "range": "500 英里",
        "components": "V、S、M（价值至少 5gp 的材料制成的一个你自身的微缩模型）",
        "duration": "专注，至多 1 日",
        "classes": ["吟游诗人", "法师"],
    ...
    },
    {
        ...
        "castingTime": "1 动作",
        "range": "触及",
        "components": "V、S、M（圣水或者银和铁的粉末，作为该法术的耗材）",
        "duration": "专注，至多 10 分钟",
        "classes": ["牧师", "圣武士", "邪术师", "法师"],
        "description": "在法术终止前，你触碰的一个自愿生物获得针对以下一种指定类型生物的防护：异怪、天界生物、元素生物、精类生物、邪魔和不死生物。\n该防护提供以下增益：该类生物对目标生物进行的攻击检定具有劣势；目标不会被该类生物魅惑，恐慌或附身；如果目标已被该类生物影响而陷入魅惑、恐慌，或被附身，则目标之后进行对抗相关效应的豁免检定时具有优势。"
    },
    {
        "name": "防护毒素",
    ...
    },
    {
        ...
        "castingTime": "1 小时",
        "range": "触及",
        "components": "V、S、M（一颗至少价值 500gp 的钻石，作为该法术的耗材）",
        "duration": "立即",
        "classes": ["吟游诗人", "牧师", "圣武士"],
        "description": "你触碰一个已死的生物，使其复活。该生物的死亡时间必须不超过 10 日。如果该生物的灵魂愿意并且能够回到其身体中，则它将以 1 点生命值重生。该法术同样会中和该生物生前体内的毒素以及罹患的非魔法疾病，但对于魔法造成的疾病、诅咒和类似的效应则无能为力；如果没有在复活前治愈这些效应，则它们在该生物重获生命的时候继续生效。该法术不能复活不死生物。\n该法术能治愈所有致命伤，但无法恢复失去的身体部位。如果该生物缺失了它生存所必要的身体部位或器官（比如头），则该法术自动失败。\n死而复生是一个痛苦的体验。复活的目标在随后进行攻击检定、豁免检定和属性检定时具有－4 减值。该目标每完成一次长休，其减值就减少 1，依次叠加直至减值完全消失。"
    },
    {
        "name": "拉瑞心灵联结",
        "englishName": "Rary's Telepathic Bond",
        "level": 5,
        "school": "预言",
        "castingTime": "1 动作",
        "range": "30 尺",
        "components": "V、S、M（两种不同生物的蛋壳碎片）",
        "duration": "1 小时",
        "classes": ["法师"],
    ...
    },
    {
        ...
        "duration": "立即",
        "classes": ["术士", "法师"],
        "description": "一道冰冷的蓝白色光线朝施法距离内的一个生物射去。你对目标进行一次远程法术攻击。若命中，则目标受到 1d8 点寒冷伤害，并且在你的下一回合开始前速度减少 10 尺。\n你到达 5 级时，该法术的伤害增加 1d8（变为 2d8）。11 级时再加 1d8（变为 3d8），17 级时再加 1d8（变为 4d8）。"
    },
    {
        "name": "致病射线",
    ...
    },
    {
        ...
        "castingTime": "1 小时",
        "range": "触及",
        "components": "V、S、M（价值至少 1000gp 的稀有油和软膏，作为该法术的耗材）",
        "duration": "立即",
        "classes": ["德鲁伊"],
    ...
    },
    {
        ...
        "castingTime": "1 小时",
        "range": "触及",
        "components": "V、S、M（一颗至少价值 1000gp 的钻石，作为该法术的耗材）",
        "duration": "立即",
        "classes": ["吟游诗人", "牧师"],
    ...
    },
    {
        ...
        "castingTime": "1 动作",
        "range": "触及",
        "components": "V、S、M（消耗总价值至少 300gp 的钻石）",
        "duration": "立即",
        "classes": ["牧师", "圣武士"],
        "description": "你触碰一个在前一分钟内刚刚死去的生物，使该生物以 1点生命值重生。该法术不能复活老死的生物，也不能恢复失去的身体部位。"
    },
    {
        "name": "魔绳术",
        ...
        "castingTime": "1 动作",
        "range": "触及",
        "components": "V、S、M（玉米粉和一卷羊皮纸绞成得纸圈）",
        "duration": "1 小时",
        "classes": ["法师"],
    ...
    },
    {
        ...
        "castingTime": "10 分钟",
        "range": "自身",
        "components": "V、S、M（一个至少价值 1,000 gp 的聚焦镜，例如水晶球、银镜、圣水盆）",
    ...
    },
    {
        ...
        "duration": "专注，至多 1 分钟",
        "classes": ["圣武士"],
        "description": "你在法术持续时间内下一次用近战武器攻击命中某个生物时将在武器上闪现出白热的光芒。该攻击对目标造成额外的1d6 点火焰伤害，并点燃目标。直至法术终止前，目标在自己每一回合开始时都要进行一次体质豁免。豁免失败则受到 1d6点火焰伤害。豁免成功则法术终止。如果目标或其身边 5 尺内的另一个生物用一个动作来扑灭其身上的火焰，或有其他某种效果熄灭了火焰（例如目标跳入水中），则法术终止。\n升环施法效应。使用 2 环或更高法术位施展该法术时，你使用的法术位每比 1 环高一环，最初一次攻击造成的额外伤害就增加 1d6。"
    },
    {
        "name": "识破隐形",
    ...
    },
    {
        ...
        "castingTime": "1 动作",
        "range": "触及",
        "components": "V、S、M（钻石、绿宝石、红宝石、蓝宝石得粉尘混合而成的粉末，其价值至少 5000gp，作为该法术的耗材）",
        "duration": "直至被解除",
        "classes": ["法师"],
        "description": "该法术能够将一个自愿的生物或物体藏匿起来，使其在法术结束前都无法被侦测。施展该法术并且触碰目标时，目标变为隐形且不能被作为预言系法术的目标，也无法被预言系法术创造出的传感器所感知。\n如果法术的目标是一个生物，则目标将进入假死状态。时间在受术者的世界中停止了流动，因此它不会衰老。\n你可以设置一个让该法术提前终止的条件。该条件由你自由设定，但必须是发生在目标周围 1 里内或目标在周围一英里内能看见的事件。例如：1000 年以后或者当泰拉斯奎巨兽觉醒时。如果受术者受到任何伤害，则该法术立刻终止。"
    },
    {
        "name": "形体变化",
        ...
        "castingTime": "1 动作",
        "range": "自身",
        "components": "V、S、M（至少价值 1,500gp 的玉环，施法时将环戴在头上）",
        "duration": "专注，至多 1 小时",
        "classes": ["德鲁伊", "法师"],
    ...
    },
    {
        ...
        "duration": "1 轮",
        "classes": ["术士", "法师"],
        "description": "一道看不见的法力护盾浮现在你身边，保护着你。在你的下一回合开始前，你的 AC 具有 +5 加值（在触发该法术的攻击之前生效），并且不会受到魔法飞弹的伤害。"
    },
    {
        "name": "虔诚护盾",
    ...
    },
    {
        ...
        "castingTime": "1 附赠动作",
        "range": "触及",
        "components": "V、S、M（一些槲寄生，一片三叶草叶子，以及一根短棒 club 或长棍 quarterstaff）",
        "duration": "一分钟",
        "classes": ["德鲁伊"],
        "description": "你将自然之力灌入手中持握的一根短棒或长棍中。你在法术持续时间内使用该武器进行近战攻击时，可以用你的施法关键属性值代替力量值来进行攻击检定和伤害掷骰，且该武器的伤害骰变为 d8。此外，若该武器原来不是魔法武器，则它将变成魔法武器。你再次施展该法术或丢掉该武器时，该法术也随之终止。"
    },
    {
        "name": "电爪",
    ...
    },
    {
        ...
        "castingTime": "12 小时",
        "range": "触及",
        "components": "V、S、M（一些雪或冰，用来给模拟对象制作一个真人大小的模型；放置在模型上的模拟对象身体的一部分，比如毛发或指甲；以及撒在分身上至少价值 1500gp 的红宝石粉，作为该法术的耗材）",
        "duration": "直至被解除",
        "classes": ["法师"],
    ...
    },
    {
        ...
        "castingTime": "1 动作",
        "range": "触及",
        "components": "V、S、M（价值 100gp 的钻石粉尘作为该法术的耗材）",
        "duration": "专注，至多 1 小时",
        "classes": ["德鲁伊", "游侠", "术士", "法师"],
    ...
    },
    {
        ...
        "castingTime": "1 附赠动作",
        "range": "触及",
        "components": "V、S、M（一个箭袋，其内至少要有一发弹药）",
        "duration": "专注，至多 1 分钟",
        "classes": ["游侠"],
    ...
    },
    {
        ...
        "castingTime": "1 分钟",
        "range": "10 尺",
        "components": "V、M（稀有粉笔和浸有价值 50gp 珍稀宝石的墨水，作为该法术的耗材）",
        "duration": "1 轮",
        "classes": ["吟游诗人", "术士", "法师"],
    ...
    {
        "name": "谭森浮碟术",
        "englishName": "Tenser's Floating Disk",
        "level": 1,
        "school": "咒法",
        "castingTime": "1 动作",
        "range": "30 尺",
    ...
    },
    {
        ...
        "duration": "立即",
        "classes": ["德鲁伊"],
        "description": "你创造出一条藤蔓般的带刺长鞭，并猛抽向施法距离内一个你指定的生物。对目标进行一次近战法术攻击，如果命中，则目标受到 1d6点穿刺伤害，如果目标生物为大型或更小体型，则其将朝你所在位置拉近至多 10 尺。\n你到达 5 级时，该法术的伤害增加 1d6（变为 2d6）。11 级时再加 1d6（变为 3d6），17 级时再加 1d6（变为 4d6）。"
    },
    {
        "name": "雷鸣斩",
    ...
    },
    {
        ...
        "castingTime": "1 小时",
        "range": "触及",
        "components": "V、S、M（少量圣水和至少价值 25,000 gp 的钻石，作为该法术的耗材）",
        "duration": "立即",
        "classes": ["德鲁伊", "牧师"],
    ...
    },
    {
        ...
        "castingTime": "1 动作",
        "range": "触及",
        "components": "V、S、M（由蘑菇粉、藏红花和油脂制成得眼药膏，价值为 25gp，作为该法术耗材）",
        "duration": "1 小时",
        "classes": ["吟游诗人", "牧师", "术士", "邪术师", "法师"],
    ...
    },
    {
        ...
        "castingTime": "1 动作",
        "range": "120 尺",
        "components": "V、S、M（由纯净的宝石原石碾成的一小撮粉末）",
        "duration": "专注，至多 10 分钟",
        "classes": ["法师"],
        "description": "一面看不见的力墙出现在施法距离内你指定的一点。这面力墙的方向由你决定：你可以使力墙成为水平或垂直的结界，亦可以使它形成一定倾角。它可以浮在空中，也可以立于地上。你可以将它塑成半球状或球状（半径最长 10 尺），也可以塑成一个由十个 10 尺×10 尺的方板块构成的平面，而每块板块都必须要和至少一块其他板块相连。不管形状如何，力墙的厚度总是 1/4 寸。力场墙将持续存在至法术终止。如果力墙形成时穿过了某个生物所占据的空间，则该生物会被推到力墙的一侧（由你决定推到哪一侧）。\n没有任何事物可以通过物理方式穿过力墙。力墙免疫所有伤害，也不能被解除魔法 dispel magic 所解除，但法术解离术disintegrate 可以使其立即摧毁。力墙能够延伸进以太位面，因此可以阻断进入以太位面穿过墙壁旅行。"
    },
    {
        "name": "冰墙术",
    ...
    },
    {
        ...
        "castingTime": "1 动作",
        "range": "触及",
        "components": "V、S、M（一对单个价值至少 50gp 的铂金戒指，并由你和目标在法术持续时间内一直佩戴）",
        "duration": "1 小时",
        "classes": ["牧师"],
    ...
    },
    {
        ...
        "duration": "专注，至多 1 分钟",
        "classes": ["法师"],
        "description": "你利用一群生物最恐惧的事物，在它们的心中创造出一个只有它们自己能看见的虚幻生物。指定施法距离内一点为中心，其周边半径 30 尺球状区域内的所有生物必须进行一次感知豁免。豁免失败者将在法术终止前陷入恐慌。该法术造出的幻象能唤起受术者心中最深的恐惧，使它最恐怖的噩梦显现为一个永远无法摆脱的威胁。如果生物因该法术陷入恐慌，则它在自己每回合结束时必须进行一次感知豁免，豁免失败则受到 4d10点心灵伤害。豁免成功则此法术在该生物身上的效应终止。"
    },
    {
        "name": "御风而行",
        ...
        "duration": "8 小时",
        "classes": ["德鲁伊"],
        "description": "你和施法距离内你能看见的至多十个自愿生物在法术持续时间内变为气化形态，其外观有如一团云雾。处于该云雾形态的生物具有 300 尺的飞行速度，并且对非魔法武器造成的伤害具有抗性。该形态下的生物除疾走 Dash 和变回原形以外不能执行其他动作。变回原形需要花一分钟的时间，在这段时间内该生物处于失能状态且不能移动。在法术终止前，该生物还可以再次变成云雾形态，而再次进行变形同样要花一分钟时间。\n如果法术终止时受术生物正以云雾形态飞行，则该生物将在 1 分钟内以每轮 60 尺的速度降落直至安全着陆。如果该生物降落 1 分钟后还没着陆，则在余下的距离中它将会如正常情况一样坠落。"
    },
    {
        "name": "风墙术",
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (spellsBtn) {
        spellsBtn.addEventListener('click', openSpellsDialog);
    }
});

// 打开法术查询对话框
function openSpellsDialog() {
    // 创建对话框容器
    const modalOverlay = document.createElement('div');
    modalOverlay.className = 'modal-overlay';
    
    const modalContent = document.createElement('div');
    modalContent.className = 'modal-content spells-modal';
    ...
    modalTitle.textContent = 'DND法术查询器';
    ...
    nameFilterGroup.className = 'filter-group';
    
    const nameLabel = document.createElement('label');
    nameLabel.setAttribute('for', 'spell-name');
    nameLabel.textContent = '法术名称:';
    
    const nameInput = document.createElement('input');
    nameInput.setAttribute('type', 'text');
    nameInput.setAttribute('id', 'spell-name');
    nameInput.setAttribute('placeholder', '输入法术名称...');
    
    nameFilterGroup.appendChild(nameLabel);
    nameFilterGroup.appendChild(nameInput);
    
    // 法术等级筛选
    const levelFilterGroup = document.createElement('div');
    levelFilterGroup.className = 'filter-group';
    
    const levelLabel = document.createElement('label');
    levelLabel.textContent = '法术等级:';
    
    const levelCheckboxes = document.createElement('div');
    levelCheckboxes.className = 'spell-level-checkboxes';
    
    for (let i = 0; i <= 9; i++) {
        const levelText = i === 0 ? '戏法' : `${i}环`;
        
        const checkboxContainer = document.createElement('div');
        checkboxContainer.className = 'level-checkbox';
        
        const checkbox = document.createElement('input');
        checkbox.setAttribute('type', 'checkbox');
        checkbox.setAttribute('id', `level-${i}`);
        checkbox.setAttribute('value', i);
        
        const checkboxLabel = document.createElement('label');
        checkboxLabel.setAttribute('for', `level-${i}`);
        checkboxLabel.textContent = levelText;
        
        checkboxContainer.appendChild(checkbox);
        checkboxContainer.appendChild(checkboxLabel);
        
        levelCheckboxes.appendChild(checkboxContainer);
    }
    
    levelFilterGroup.appendChild(levelLabel);
    levelFilterGroup.appendChild(levelCheckboxes);
    
    // 学派筛选
    const schoolFilterGroup = document.createElement('div');
    schoolFilterGroup.className = 'filter-group';
    
    const schoolLabel = document.createElement('label');
    schoolLabel.setAttribute('for', 'spell-school');
    schoolLabel.textContent = '法术学派:';
    
    const schoolSelect = document.createElement('select');
    schoolSelect.setAttribute('id', 'spell-school');
    
    const schoolOption = document.createElement('option');
    schoolOption.setAttribute('value', '');
    schoolOption.textContent = '所有学派';
    ...
    schoolFilterGroup.appendChild(schoolLabel);
    schoolFilterGroup.appendChild(schoolSelect);
    
    // 职业筛选
    const classFilterGroup = document.createElement('div');
    classFilterGroup.className = 'filter-group';
    
    const classLabel = document.createElement('label');
    classLabel.setAttribute('for', 'spell-class');
    classLabel.textContent = '职业:';
    
    const classSelect = document.createElement('select');
    classSelect.setAttribute('id', 'spell-class');
    
    const classOption = document.createElement('option');
    classOption.setAttribute('value', '');
    classOption.textContent = '所有职业';
    classSelect.appendChild(classOption);
    
    const classes = ['吟游诗人', '牧师', '德鲁伊', '圣武士', '游侠', '术士', '邪术师', '法师', '武僧'];
    classes.forEach(cls => {
        const option = document.createElement('option');
    ...
    classFilterGroup.appendChild(classLabel);
    classFilterGroup.appendChild(classSelect);
    
    // 添加筛选器到容器
    filtersContainer.appendChild(nameFilterGroup);
    filtersContainer.appendChild(levelFilterGroup);
    filtersContainer.appendChild(schoolFilterGroup);
    filtersContainer.appendChild(classFilterGroup);
    ...
    resultsContainer.id = 'spell-results';
    
    // 添加初始提示
    const initialMessage = document.createElement('div');
    initialMessage.className = 'initial-message';
    initialMessage.textContent = '请使用上方的筛选条件查找法术...';
    resultsContainer.appendChild(initialMessage);
    
    // 创建法术详情容器（初始隐藏）
    const spellDetailContainer = document.createElement('div');
    spellDetailContainer.className = 'spell-detail-container';
    spellDetailContainer.id = 'spell-detail';
    spellDetailContainer.style.display = 'none';
    ...
    spellDetailContainer.appendChild(backButton);
    
    // 组装对话框
    modalContent.appendChild(modalHeader);
    modalContent.appendChild(filtersContainer);
    modalContent.appendChild(resultsContainer);
    modalContent.appendChild(spellDetailContainer);
    ...
    function filterSpells() {
        ...
        const filteredSpells = spellsData.filter(spell => {
            // 名称筛选
            const nameMatch = spell.name.toLowerCase().includes(nameFilter) || 
                              (spell.englishName && spell.englishName.toLowerCase().includes(nameFilter));
            
            // 学派筛选
            const schoolMatch = !selectedSchool || spell.school === selectedSchool;
            
            // 职业筛选
            const classMatch = !selectedClass || (spell.classes && spell.classes.includes(selectedClass));
            
            // 等级筛选
            const levelMatch = selectedLevels.length === 0 || selectedLevels.includes(spell.level);
            
            return nameMatch && schoolMatch && classMatch && levelMatch;
        });
        
        displaySpellsPreview(filteredSpells);
    }
    
    // 显示法术预览列表
    function displaySpellsPreview(spells) {
        const resultsContainer = document.getElementById('spell-results');
        resultsContainer.innerHTML = '';
        
        if (spells.length === 0) {
            resultsContainer.innerHTML = '<p>没有找到符合条件的法术。</p>';
            return;
        }
        ...
        spells.forEach(spell => {
            const spellPreview = document.createElement('div');
            spellPreview.className = 'spell-preview';
            spellPreview.dataset.spellIndex = spellsData.findIndex(s => s.name === spell.name);
            
            const nameElement = document.createElement('div');
            nameElement.className = 'spell-preview-name';
            nameElement.textContent = spell.name;
            
            const levelElement = document.createElement('div');
            levelElement.className = 'spell-preview-level';
            let levelText = spell.level === 0 ? '戏法' : `${spell.level}环`;
            levelElement.textContent = `${levelText} ${spell.school}`;
            
            spellPreview.appendChild(nameElement);
            spellPreview.appendChild(levelElement);
            
            // 添加点击事件显示详情
            spellPreview.addEventListener('click', function() {
                const spellIndex = parseInt(this.dataset.spellIndex);
                showSpellDetail(spellsData[spellIndex]);
            });
            
            resultsContainer.appendChild(spellPreview);
        });
    }
    
    // 显示法术详情
    function showSpellDetail(spell) {
        const spellDetailContainer = document.getElementById('spell-detail');
        const resultsContainer = document.getElementById('spell-results');
        
        // 清空现有内容并保留返回按钮
        const backButton = spellDetailContainer.querySelector('.back-button');
        spellDetailContainer.innerHTML = '';
        spellDetailContainer.appendChild(backButton);
        
        // 创建法术详情内容
        const spellDetail = document.createElement('div');
        spellDetail.className = 'spell-detail';
        ...
        nameElement.textContent = spell.name;
        if (spell.englishName) {
            nameElement.textContent += ` (${spell.englishName})`;
        }
        
        const levelSchoolElement = document.createElement('div');
        levelSchoolElement.className = 'spell-level-school';
        let levelText = spell.level === 0 ? '戏法' : `${spell.level}环`;
        levelSchoolElement.textContent = `${levelText} ${spell.school}`;
        
        header.appendChild(nameElement);
        header.appendChild(levelSchoolElement);
        ...
        const properties = [
            ...
            { label: '法术职业', value: spell.classes ? spell.classes.join(', ') : '' }
        ];
        
        properties.forEach(prop => {
            if (prop.value) {
                const propertyElement = document.createElement('div');
                propertyElement.className = 'spell-property';
                propertyElement.innerHTML = `<strong>${prop.label}:</strong> ${prop.value}`;
                details.appendChild(propertyElement);
            }
        });
        ...
        if (spell.description) {
            ...
            descriptionElement.innerHTML = `<strong>描述:</strong> ${spell.description.replace(/\n/g, '<br>')}`;
            details.appendChild(descriptionElement);
        }
        
        spellDetail.appendChild(header);
        spellDetail.appendChild(details);
        
        spellDetailContainer.appendChild(spellDetail);
        
        // 显示详情并隐藏列表
        resultsContainer.style.display = 'none';
        spellDetailContainer.style.display = 'block';
    }
} 
